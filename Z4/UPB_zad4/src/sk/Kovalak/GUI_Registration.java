...
public class GUI_Registration extends javax.swing.JFrame {
    ...
    private void Registracia(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Registracia
        ...
        try {
            //Kontrola rovnosti hesla a overenia hesla
            if (Arrays.equals(jPasswordField3.getPassword(), jPasswordField2.getPassword())){
                ...
                if(!Security.passwordValidation(String.valueOf(jPasswordField3.getPassword()))){
                    JOptionPane.showMessageDialog(rootPane, "Heslo je prilis slabe. Musi obsahovat aspon 6 znakov, velke alebo male pismeno a cislo.");
                }
                else {
                    String password = String.valueOf(jPasswordField2.getPassword());
                    Security security = new Security();

                    MyResult tmp = Registration.registracia(jTextField1.getText(), security.hash(password), security.getSalt());
                    if (!tmp.getFirst())
